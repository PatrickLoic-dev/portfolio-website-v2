function PartialFooter() {
    return (
        <footer className="mt-10 flex flex-col justify-center text-[12px] gap-1.5 md:flex-row md:justify-between md:text-[20px] proximaNova px-[30px] md:px-32 bg-black">
