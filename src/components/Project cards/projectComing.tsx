function ProjectComing() {
    return (
        <div className="w-full h-[220px] bg-cover bg-center rounded-[8px] flex items-end pl-4 pb-2 md:h-96 md:pl-9 md:pb-4 text-white" style={{ backgroundImage: "url('/Images/Other/Fictif project background.webp')" }}>
